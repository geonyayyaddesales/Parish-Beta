...
class FrmTransPayment extends FrmTransDb {
	...
	public function get_defaults() {
		$values = array(
			...
			'begin_date'  => array( 'sanitize' => 'sanitize_text_field', 'default' => current_time( 'mysql', 1 ) ),
			'expire_date' => array( 'sanitize' => 'sanitize_text_field', 'default' => '0000-00-00' ),
