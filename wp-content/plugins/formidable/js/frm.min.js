...
k);jQuery(document).on("change keyup",".frm-show-form .frm_inside_container input, .frm-show-form .frm_inside_container select, .frm-show-form .frm_inside_container textarea",f);jQuery(document).on("click","a[data-frmconfirm]",I);jQuery("a[data-frmtoggle]").click(J);K();L();M();N()},getFieldId:function(a,b){return e(a,b)},renderRecaptcha:function(a){var b=a.getAttribute("data-size"),c={sitekey:a.getAttribute("data-sitekey"),size:b,theme:a.getAttribute("data-theme")};if("invisible"===b){var d=jQuery(a).closest("form").find('input[name="form_id"]').val();
...
d))))},submitFormNow:function(a){-1<a.className.trim().split(/\s+/gi).indexOf("frm_ajax_submit")?1>jQuery(a).find('input[type="file"]').filter(function(){return!!this.value}).length?(r=jQuery(a).find('input[name="frm_action"]').val(),frmFrontForm.checkFormErrors(a,r)):a.submit():a.submit()},validateFormSubmit:function(a){"undefined"!==typeof tinyMCE&&jQuery(a).find(".wp-editor-wrap").length&&tinyMCE.triggerSave();m=[];var b=jQuery(a).hasClass("frm_js_validate");b&&"undefined"!==typeof frmProForm&&
(frmProForm.savingDraft(a)||frmProForm.goingToPreviousPage(a))&&(b=!1);b&&(frmFrontForm.getAjaxFormErrors(a),Object.keys(m).length&&frmFrontForm.addAjaxFormErrors(a));return m},getAjaxFormErrors:function(a){var b=[],c=jQuery(a).find(".frm_required_field:visible input, .frm_required_field:visible select, .frm_required_field:visible textarea").filter(":not(.frm_optional)");if(c.length)for(var d=0,e=c.length;d<e;d++)b=n(c[d],b);c=jQuery(a).find("input[type=email]").filter(":visible");d=jQuery(a).find("input,select,textarea");
if(d.length){e=0;for(var f=d.length;e<f;e++){var g=d[e];""!==g.value&&"hidden"!==g.type&&("number"===g.type?b=w(g,b):"email"===g.type?b=v(g,b,c):null!==g.pattern&&(b=x(g,b)))}}c=jQuery(a).find(".frm-g-recaptcha");c.length&&(d=c.data("rid"),0===grecaptcha.getResponse(d).length&&(c=c.closest(".frm_form_field").attr("id").replace("frm_field_","").replace("_container",""),b[c]=""));m=b;if("function"===typeof frmThemeOverride_jsErrors&&(r=jQuery(a).find('input[name="frm_action"]').val(),a=frmThemeOverride_jsErrors(r,
a),Object.keys(a).length))for(var k in a)m[k]=a[k];return m},addAjaxFormErrors:function(a){y();for(var b in m){var c=jQuery(a).find("#frm_field_"+b+"_container");c.length?t(c,b,m):delete m[b]}z(a)},checkFormErrors:function(a,b){D(a,b)},checkRequiredField:function(a,b){return n(a,b)},showSubmitLoading:function(a){B(a)},removeSubmitLoading:function(a,b,c){u(a,b,c)},scrollToID:function(a){a=jQuery(document.getElementById(a));frmFrontForm.scrollMsg(a,!1)},scrollMsg:function(a,b,c){if("undefined"===typeof b){if(a=
...
e.hasClass("dz-clickable"))){var h=c[a].maxFiles;if("undefined"!==typeof c[a].mockFiles){var g=c[a].mockFiles.length;0<h&&(h-=g)}var k=e.closest("form");g="#"+k.attr("id");"#undefined"==g&&(g="form."+k.attr("class").replace(" ","."));e.dropzone({url:frm_js.ajax_url,addRemoveLinks:!0,paramName:e.attr("id").replace("_dropzone",""),maxFilesize:c[a].maxFilesize,maxFiles:h,uploadMultiple:c[a].uploadMultiple,hiddenInputContainer:g,dictDefaultMessage:c[a].defaultMessage,dictFallbackMessage:c[a].fallbackMessage,
dictFallbackText:c[a].fallbackText,dictFileTooBig:c[a].fileTooBig,dictInvalidFileType:c[a].invalidFileType,dictResponseError:c[a].responseError,dictCancelUpload:c[a].cancel,dictCancelUploadConfirmation:c[a].cancelConfirm,dictRemoveFile:c[a].remove,dictMaxFilesExceeded:c[a].maxFilesExceeded,fallback:function(){jQuery(this.element).closest("form").removeClass("frm_ajax_submit")},init:function(){this.on("sending",function(b,f,e){f=d;var h=jQuery(f).closest("form");if(1>h.length)f=!1;else if(h=jQuery(h).find(".frm_required_field:visible input, .frm_required_field:visible select, .frm_required_field:visible textarea, "+
f),1>h.length)f=!0;else{for(var g=!0,k=0,l=h.length;k<l&&"#"+h[k].id!==f;k++)if(!(-1<h[k].className.indexOf("frm_optional")||null!==h[k].getAttribute("data-frmfile")))if(1>frmFrontForm.checkRequiredField(h[k],[]).length){g=!0;break}else g=!1;f=g}if(f){f=""!==document.getElementById("frm_verify_"+c[a].parentFormID).value||window._phantom||window.callPhantom||window.__phantomas||window.Buffer||window.emit||window.spawn?!0:!1;if(f)return this.removeFile(b),alert(frm_js.file_spam),!1;e.append("action",
"frm_submit_dropzone");e.append("field_id",c[a].fieldID);e.append("form_id",c[a].formID);e.append("nonce",frm_js.nonce)}else return this.removeFile(b),alert(frm_js.empty_fields),!1});this.on("success",function(b,d){for(var e=jQuery.parseJSON(d),h=0;h<e.length;h++)!0!==c[a].uploadMultiple&&jQuery('input[name="'+f+'"]').val(e[h])});this.on("successmultiple",function(b,d){for(var e=jQuery.parseJSON(d),h=0;h<b.length;h++)jQuery(b[h].previewElement).append(aa(c[a],e[h],f))});this.on("complete",function(b){u--;
frmFrontForm.removeSubmitLoading(k,"enable",u);if("undefined"!==typeof b.mediaID){c[a].uploadMultiple&&jQuery(b.previewElement).append(aa(c[a],b.mediaID,f));for(var d=b.previewElement.querySelectorAll("[data-dz-name]"),e=0,h=d.length;e<h;e++)d[e].innerHTML='<a href="'+b.url+'" target="_blank" rel="noopener">'+b.name+"</a>"}});this.on("addedfile",function(){u++;frmFrontForm.showSubmitLoading(k)});this.on("removedfile",function(b){!1!==b.accepted&&!0!==c[a].uploadMultiple&&jQuery('input[name="'+f+'"]').val("");
!1!==b.accepted&&"undefined"!==typeof b.mediaID&&(jQuery(b.previewElement).remove(),this.options.maxFiles=c[a].maxFiles-this.files.length)});if("undefined"!==typeof c[a].mockFiles)for(var b=0;b<c[a].mockFiles.length;b++){var e={name:c[a].mockFiles[b].name,size:c[a].mockFiles[b].size,url:c[a].mockFiles[b].file_url,mediaID:c[a].mockFiles[b].id};this.emit("addedfile",e);this.emit("thumbnail",e,c[a].mockFiles[b].url);this.emit("complete",e);this.files.push(e)}}})}}function aa(a,b,c){return'<input name="'+
c+'[]" type="hidden" value="'+b+'" data-frmfile="'+a.fieldID+'" />'}function Ra(){var a=jQuery(this).data("frm-remove");Sa(jQuery(this).parent(".dz-preview"));a=jQuery('input[name="'+a+'"]');a.length&&a.val("")}function Ta(){var a=this.type,b=!1,c=!1;if("select-one"===a)c=!0,"frm_other_trigger"===this.options[this.selectedIndex].className&&(b=!0);else if("select-multiple"===a){c=!0;var d=this.options;b=!1;for(var f=0;f<d.length;f++)if("frm_other_trigger"===d[f].className&&d[f].selected){b=!0;break}}c?
...
jQuery(this).closest(".frm_checkbox").children(".frm_other_input").addClass("frm_pos_none").val(""))}function ba(a,b,c,d){a=jQuery(b);ca(c,a);d="undefined"!==typeof d.originalEvent||-1<d.currentTarget.className.indexOf("frm_chzn")?"value changed":"other";da(c,a,d);I(c,a)}function ca(a,b){if(!("undefined"===typeof __FRMRULES||"undefined"===typeof __FRMRULES[a]||1>__FRMRULES[a].dependents.length||null===b||"undefined"===typeof b))for(var c=__FRMRULES[a],d=w(b[0].name),f=0,e=c.dependents.length;f<e;f++)x(c.dependents[f],
d)}function x(a,b){var c=J(a);if(!(!1===c||1>c.conditions.length)){var d=[];if(c.isRepeating)if(""!==b.repeatingSection){var f="frm_field_"+c.fieldId+"-";f+=b.repeatingSection+"-"+b.repeatRow+"_container";d.push(f)}else if(d=B(c),null!==document.getElementById("frm_field_"+d+"_container")){d=[];f=document.querySelectorAll(".frm_field_"+c.fieldId+"_container");for(var e=0,h=f.length;e<h;e++)d.push(f[e].id)}else{d=[];e=B(c);f="frm_field_"+c.fieldId+"-"+e+"-";e=document.querySelectorAll('[name="item_meta['+
e+'][row_ids][]"]');h=0;for(var g=e.length;h<g;h++)""!==e[h].value&&d.push(f+e[h].value+"_container");1>d.length&&d.push(f+"0_container")}else d.push("frm_field_"+c.fieldId+"_container");f=d.length;for(e=0;e<f;e++)c.containerId=d[e],ea(c,d[e]),fa(c)}}function B(a){var b="";"0"!==a.inEmbedForm?b=a.inEmbedForm:"0"!==a.inSection&&(b=a.inSection);return b}function ea(a,b){if(a.isRepeating){var c=b.replace("_container","").split("-");a.repeatRow=c[2]}else a.repeatRow=""}function fa(a){for(var b=[],c=a.conditions.length,
d=0;d<c;d++)b.push(Ua(a.conditions[d],a));c=Va="any"==a.anyAll?-1<b.indexOf(!0)?a.showHide:ha(a.showHide):-1<b.indexOf(!1)?ha(a.showHide):a.showHide;b=null!==document.getElementById(a.containerId);"show"==c?"data"==a.fieldType&&a.hasOwnProperty("dataLogic")?(a={fieldId:a.fieldId,fieldKey:a.fieldKey,formId:a.formId,containerId:a.containerId,repeatRow:a.repeatRow,dataLogic:{actualValue:a.dataLogic.actualValue,fieldId:a.dataLogic.fieldId},children:"",inputType:a.inputType},"data"==a.inputType?Wa(a,b):
b&&Xa(a)):!1!==v(a.containerId,a.formId)&&(y(a.containerId,a.formId),b?(b=ia(a.containerId),ja(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId),jQuery("#"+a.containerId).show()):(b=ka(a),ja(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId))):K(a,b)}function J(a){return"undefined"===typeof __FRMRULES||"undefined"===typeof __FRMRULES[a]?!1:__FRMRULES[a]}function Ua(a,b){var c=J(a.fieldId),d=la(c,b);"data"==b.fieldType&&"data"==c.fieldType?(c=""===a.value?""===d||1==d.length&&""===d[0]?
!1:!0:L(a.operator,a.value,d),b.dataLogic=a,b.dataLogic.actualValue=d,d=c):d=L(a.operator,a.value,d);return d}function la(a,b){if("radio"==a.inputType||"checkbox"==a.inputType){var c=ma(a,b);c=document.querySelectorAll('input[name^="'+c+'"]');c="checkbox"==a.inputType?C(c):M(c)}else if(!0===a.isMultiSelect){c=ma(a,b);var d=document.querySelectorAll('[name^="'+c+'"]');1==d.length&&"hidden"!=d[0].type?(c=jQuery('[name^="'+c+'"]').val(),null===c&&(c="")):c=C(d)}else if(c="field_"+a.fieldKey,a.isRepeating&&
(c+="-"+b.repeatRow),d=document.getElementById(c),null===d){d="";if("time"==a.fieldType){var f=document.getElementById(c+"_H");null!==f&&(d=document.getElementById(c+"_m"),d=f.value+":"+d.value,c=document.getElementById(c+"_A"),":"==d?d="":null!==c&&(d+=" "+c.value))}c=d}else c=d.value;"undefined"===typeof c?c="":"string"===typeof c&&(c=c.trim());return c}function ma(a,b){return a.isRepeating?"item_meta["+("0"!==b.inEmbedForm?b.inEmbedForm:b.inSection)+"]["+b.repeatRow+"]["+a.fieldId+"]":"item_meta["+
a.fieldId+"]"}function C(a){for(var b=[],c=0,d=a.length;c<d;c++)("hidden"==a[c].type||a[c].checked)&&b.push(a[c].value);0===b.length&&(b=!1);return b}function L(a,b,c){b=Ya(b);c=Za(b,c);return"string"===typeof b&&"-1"!=b.indexOf("&quot;")&&L(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a===b},"!=":function(a,b){return a!==b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){if(!b)return!1;a=N(a);b=na(a,b);return-1!=b.indexOf(a)},"not LIKE":function(a,b){if(!b)return!0;
a=N(a);b=na(a,b);return-1==b.indexOf(a)}}[a](b,c)}function Ya(a){-1!==String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)?a=parseFloat(a):"string"===typeof a&&(a=a.trim());return a}function Za(a,b){if("undefined"===typeof b||null===b)b="";jQuery.isArray(b)&&-1<jQuery.inArray(String(a),b)&&(b=a);"number"===typeof a&&"string"===typeof b&&(b=parseFloat(b));"string"===typeof b&&(b=b.trim());return b}function na(a,b){b=N(b);if(jQuery.isArray(b))for(var c=0,d=b.length;c<d;c++){var f=b[c].toLowerCase();
if(-1<f.indexOf(a)){b=a;break}}return b}function N(a){"string"===typeof a?a=a.toLowerCase():"number"===typeof a&&(a=a.toString());return a}function ha(a){return"show"==a?"hide":"show"}function ia(a){return document.getElementById(a).querySelectorAll('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]')}function ka(a){if("divider"==a.fieldType){var b=[];"divider"==a.fieldType&&(b=document.querySelectorAll('[data-sectionid="'+a.fieldId+'"]'));a=b}else"form"==a.fieldType?
a=document.querySelectorAll('[id^="field_'+a.fieldKey+'-"]'):(a=a.isRepeating?"item_meta["+B(a)+"]["+a.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]",a=document.querySelectorAll('[name^="'+a+'"]'));return a}function ja(a,b,c){if(a.length)for(var d,f=["checkbox","radio"],e=0;e<a.length;e++)if(!(0<e&&"undefined"!==typeof d&&d.name==a[e].name&&-1<f.indexOf(d.type)||b&&D(a[e],c))){d=a[e];var h=jQuery(d),g=h.data("frmval");if("undefined"!==typeof g){if("checkbox"==d.type||"radio"==d.type)oa(d.name,
g);else if(-1<d.name.indexOf("[]")){var k=document.getElementsByName(d.name);if(jQuery.isArray(g))for(var l=0,m=g.length;l<m;l++)l in k&&(k[l].value=g[l]);else null!==k[0]&&(k[0].value=g)}else g.constructor===Object&&(k=d.getAttribute("name").split("[").slice(-1)[0],null!==k&&(k=k.replace("]",""),g=g[k],"undefined"==typeof g&&(g=""))),d.value=g;"SELECT"==d.tagName&&E(d);r(h)}d=a[e];h=frmFrontForm.getFieldId(d,!1);h=O(h);!1!==h&&"lookup"!=h.fieldType&&pa(h,d,"value changed");d=a[e];if(h="undefined"!==
typeof __FRMCALC){h=d.type;g=!1;if("text"==h||"hidden"==h||"number"==h)g=!0;h=g}if(h){h=__FRMCALC;g=d.name;k=d.id.replace("field_","");if(A(g))for(g=k.split("-"),k="",l=0;l<g.length-1;l++)k=""===k?g[l]:k+"-"+g[l];g=k;k=null;A(d.name)&&(k="hidden"!=d.type?jQuery(d).closest(".frm_form_field"):jQuery(d));d=k;void 0!==h.calc[g]&&P(h,g,[],d)}d=a[e]}}function D(a,b){var c=frmFrontForm.getFieldId(a,!0);return v("frm_field_"+c+"_container",b)}function K(a,b){if(!v(a.containerId,a.formId)){qa(a.containerId,
a.formId);if(b){jQuery("#"+a.containerId).hide();var c=ia(a.containerId)}else c=ka(a);Q(c)}}function Q(a){if(!(1>a.length)){for(var b,c=!0,d=0,f=a.length;d<f;d++)-1<a[d].className.indexOf("frm_dnc")||(0<d&&b.name!=a[d].name&&!0===c&&r(jQuery(b)),c=!0,"radio"==a[d].type||"checkbox"==a[d].type?a[d].checked=!1:"SELECT"==a[d].tagName?(0===a[d].selectedIndex?c=!1:a[d].selectedIndex=0,b=a[d].id.replace(/[^\w]/g,"_"),null!==document.getElementById(b+"_chosen")&&jQuery(a[d]).trigger("chosen:updated")):a[d].value=
""),b=a[d];!0===c&&r(jQuery(b))}}function v(a,b){var c=!1;-1<z(b).indexOf(a)&&(c=!0);return c}function qa(a,b){var c=z(b);if(!(-1<c.indexOf(a))){c.push(a);c=JSON.stringify(c);var d=document.getElementById("frm_hide_fields_"+b);null!==d&&(d.value=c)}}function z(a){var b=[];a=document.getElementById("frm_hide_fields_"+a);return null===a?b:b=(b=a.value)?JSON.parse(b):[]}function oa(a,b){for(var c=document.getElementsByName(a),d=0,f=c.length;d<f;d++)if("hidden"==c[d].type)jQuery.isArray(b)&&null!==b[d]?
c[d].value=b[d]:c[d].value=b;else if(c[d].value==b||jQuery.isArray(b)&&-1<b.indexOf(c[d].value))if(c[d].checked=!0,"radio"==c[d].type)break}function y(a,b){var c=z(b),d=c.indexOf(a);-1<d&&(c.splice(d,1),c=JSON.stringify(c),document.getElementById("frm_hide_fields_"+b).value=c)}function da(a,b,c){if(!("undefined"===typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]||1>__FRMLOOKUP[a].dependents.length||null===b||"undefined"===typeof b)){a=__FRMLOOKUP[a];b=w(b[0].name);for(var d=0,f=a.dependents.length;d<
f;d++)R(a.dependents[d],b,c)}}function R(a,b,c){a=O(a);if(!(!1===a||1>a.parents.length))if("lookup"==a.fieldType){if(""!==b.repeatRow){c=[];var d="frm_field_"+a.fieldId+"-";d+=b.repeatingSection+"-"+b.repeatRow+"_container";b=document.getElementById(d);null!==b&&c.push(b);b=c}else b=[],a.isRepeating?b=document.querySelectorAll(".frm_field_"+a.fieldId+"_container"):(c=document.getElementById("frm_field_"+a.fieldId+"_container"),null!==c&&b.push(c));c=0;for(d=b.length;c<d;c++){ea(a,b[c].id);var f=a,
e=b[c];f.parentVals=ra(f);if("select"==f.inputType)$a(f,e);else if("radio"==f.inputType||"checkbox"==f.inputType)if(!1===f.parentVals){var h=e.getElementsByTagName("input");sa(f,e);Q(h)}else ab(f,e)}}else if("value changed"===c)for(c="field_"+a.fieldKey,c=a.isRepeating?""!==b.repeatingSection?'[id="'+c+"-"+b.repeatRow+'"]':'[id^="'+c+'-"]':'[id="'+c+'"]',b=document.querySelectorAll(c),c=0,d=b.length;c<d;c++)f=a,e=w(b[c].name),f.repeatRow=""!==e.repeatRow?e.repeatRow:"",pa(a,b[c])}function O(a){return"undefined"===
typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]?!1:__FRMLOOKUP[a]}function pa(a,b){a.parentVals=ra(a);var c=b.id;c in n&&0<n[c].length?ta(a,b):(ta(a,b),ua(a,b))}function ra(a){for(var b=[],c=a.parents,d,f=0,e=c.length;f<e;f++){d=O(c[f]);d=la(d,a);if(""===d||!1===d){b=!1;break}b[f]=d}return b}function M(a){for(var b=!1,c=a.length,d=0;d<c;d++)if("hidden"==a[d].type||a[d].checked){b=a[d].value;break}return b}function $a(a,b){var c=b.getElementsByTagName("SELECT")[0];if(null!==c){var d=c.value;
!1===a.parentVals?(c.options.length=1,c.value="",E(c),""!==d&&r(jQuery(c),a.fieldKey)):(bb(c),S(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_lookup_field_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(d){var e=c.value;d=JSON.parse(d);for(var f=c.options.length;0<f;f--)c.remove(f);var g=d.length;for(f=0;f<g;f++)c.options[f+1]=new Option(d[f],d[f],!1,!1);c.value=e;""===c.value&&(d=c.getAttribute("data-frmval"),
null!==d&&(c.value=d));!1===a.isReadOnly&&(c.disabled=!1);c.className=c.className.replace(" frm_loading_lookup","");E(c);c.value!=e&&r(jQuery(c),a.fieldKey);va(jQuery(b));T(a.formId)}}))}}function E(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function bb(a){a.className+=" frm_loading_lookup";a.disabled=!0;E(a)}function S(a){u++;1===u&&(a=wa(a),null!==a&&frmFrontForm.showSubmitLoading(jQuery(a)))}function T(a){u--;0>=u&&(a=wa(a),null!==a&&frmFrontForm.removeSubmitLoading(jQuery(a),
"enable",u))}function wa(a){return document.querySelector("#frm_form_"+a+"_container form")}function ab(a,b){var c=b.getElementsByClassName("frm_opt_container")[0],d=c.getElementsByTagName("input");cb(b,c);var f="";f="radio"==a.inputType?M(d):C(d);var e=jQuery(d[0]).data("frmval");S(a.formId);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,container_field_id:B(a),row_index:a.repeatRow,
current_value:f,default_value:e,nonce:frm_js.nonce},success:function(f){c.innerHTML=f;f=b.getElementsByClassName("frm-loading-img")[0];null!==f&&void 0!==f&&f.parentNode.removeChild(f);c.style.display="block";1==d.length&&""===d[0].value?sa(a,b):(!1!==v(b.id,a.formId)&&(f=J(a.fieldId),!1===f||1>f.conditions.length?(y(b.id,a.formId),jQuery("#"+b.id).show()):(f.containerId=b.id,f.repeatRow=a.repeatRow,fa(f))),void 0!==e&&(!1!==("radio"==a.inputType?M(d):C(d))||1>d.length||oa(d[0].name,e)));r(jQuery(d[0]),
a.fieldKey);va(jQuery(b));T(a.formId)}})}function va(a){a.trigger("frmLookupOptionsLoaded")}function sa(a,b){v(b.id,a.formId)||(jQuery("#"+b.id).hide(),qa(b.id,a.formId))}function ua(a,b){if(D(b,a.formId))U(b.id);else if(!1===a.parentVals){var c=b.getAttribute("data-frmval");null===c&&(c="");xa(a,b,c);U(b.id)}else S(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},
success:function(c){D(b,a.formId)||b.value==c||xa(a.fieldKey,b,c);T(a.formId);U(b.id)}})}function ta(a,b){var c=b.id;c in n?2<=n[c].length&&(n[c]=n[c].slice(0,1)):n[c]=[];n[c].push({childFieldArgs:a,childInput:b})}function U(a){n[a].shift();a in n&&0<n[a].length&&ua(n[a][0].childFieldArgs,n[a][0].childInput)}function xa(a,b,c){c=c.replace(/&amp;/g,"&");b.value=c;r(jQuery(b),a)}function Wa(a,b){if(b){var c=jQuery("#"+a.containerId);ya(c)}jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",
entry_id:a.dataLogic.actualValue,current_field:a.fieldId,hide_id:a.containerId,on_current_page:b,nonce:frm_js.nonce},success:function(d){if(b){var f=c.find(".frm_opt_container");f.html(d);var e=f.children("input"),h=e.val();za(f);""===d||""===h?K(a,!0):Aa(a,c,e,!0)}else f="field_"+a.fieldKey,""!==a.repeatRow&&(f+="-"+a.repeatRow),f=document.getElementById(f),f.value=d,v(a.containerId,a.formId)&&y(a.containerId,a.formId),r(jQuery(f))}})}function Xa(a,b){var c=jQuery("#"+a.containerId),d=c.find('select[name^="item_meta"], input[name^="item_meta"]'),
f=Ba(d);d=d.data("frmval");var e=c.closest("form").find('input[name="id"]').val();ya(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,editing_entry:e,prev_val:f,nonce:frm_js.nonce},success:function(b){var d=c.find(".frm_opt_container");d.html(b);var e=d.find('select, input[type="checkbox"], input[type="radio"]');za(d);""===b||
1>e.length?K(a,!0):(b=Ba(e),Aa(a,c,e,f!==b))}})}function ya(a){var b=a.html();-1<b.indexOf("frm-loading-img")||(a.html(b+'<span class="frm-loading-img"></span>'),a.find(".frm_opt_container").hide())}function cb(a,b){if(!(-1<a.innerHTML.indexOf("frm-loading-img"))){b.style.display="none";var c=document.createElement("span");c.setAttribute("class","frm-loading-img");a.insertBefore(c,b.nextSibling)}}function za(a){a.parent().children(".frm-loading-img").remove();a.show()}function Ba(a){var b=[],c="";
a.each(function(){c=this.value;"radio"===this.type||"checkbox"===this.type?!0===this.checked&&b.push(c):""!==c&&b.push(c)});0===b.length&&(b="");return b}function Aa(a,b,c,d){v(a.containerId,a.formId)&&(y(a.containerId,a.formId),b.show());c.hasClass("frm_chzn")&&V();!0===d&&r(c)}function I(a,b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d){d=d.total;for(var f=d.length,e=[],h=db(c.calc[d[0]]),g=0;g<f;g++){var k=h;if("undefined"!==typeof k.start||"undefined"!==
typeof k.end){var l=jQuery('input[type=hidden][name*="['+c.calc[d[g]].field_id+']"]');if(l.length)if(l.closest(".frm_form_field").length)l=!0;else{var m=l.index(),p=!0,q=!0;"undefined"!==typeof k.start&&(p=jQuery(k.start).index()<m);"undefined"!==typeof k.end&&(q=jQuery(k.end).index()>m);(k=p&&q)||(k=0<l.closest(".do-calculation").length);l=k}else l=!0}else l=!0;l&&(l=c.calc[d[g]],q=b.attr("name"),k=!1,m=l.field_id,p=z(l.form_id),1>p.length||("0"===l.inSection&&"0"===l.inEmbedForm?k=F(m,p):(q=w(q),
F(m,p)?k=!0:Ca(m,q,p)?k=!0:"0"!==l.inSection&&"0"!==l.inEmbedForm?k=Ca(l.inSection,q,p):"0"!==l.inSection?k=F(l.inSection,p):"0"!==l.inEmbedForm&&(k=F(l.inEmbedForm,p)))),l=k,l=!1===l);l&&P(c,d[g],e,b)}}}}function db(a){var b=a.form_id,c=document.getElementById("frm_form_"+b+"_container");null===c&&a.in_section&&(a=document.getElementById("frm_field_"+a.in_section+"_container"),null!==a&&(c=Da(a,function(a){return"FORM"===a.tagName}),b=c.elements.namedItem("form_id").value));c=c.getElementsByClassName("frm_next_page");
b=document.getElementById("frm_page_order_"+b);a=[];0<c.length&&(a.start=c[0]);null!==b&&(a.end=b);return a}function Da(a,b){return a&&(b(a)?a:Da(a.parentNode,b))}function F(a,b){return-1<b.indexOf("frm_field_"+a+"_container")}function Ca(a,b,c){var d=!1;b.repeatingSection&&(a="frm_field_"+a+"-"+b.repeatingSection,a+="-"+b.repeatRow+"_container",d=-1<c.indexOf(a));return d}function P(a,b,c,d){var f=a.calc[b],e=f.calc,h=jQuery(document.getElementById("field_"+b)),g={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+
b+'-"]'};1>h.length&&"undefined"!==typeof d&&(g.inSection=!0,g.thisFieldId=eb(a.fieldsWithCalc,b),h=Ea(g));if(!(null===h||1>h.length)){e=fb(f,e,a,c,g);if("text"!=f.calc_type){a=f.calc_dec;-1<e.indexOf(").toFixed(")&&(c=e.split(").toFixed("),Fa(c[1])&&(a=c[1],e=e.replace(").toFixed("+a,"")));e=gb(e);e=parseFloat(eval(e));if("undefined"===typeof e||isNaN(e))e=0;Fa(a)&&(e=e.toFixed(a))}h.val()!==e&&(h.val(e),null!==d&&"undefined"!==typeof d&&h.attr("name")==d.attr("name")||r(h,b))}}function fb(a,b,c,
d,f){for(var e=0,h=a.fields.length;e<h;e++){var g={triggerField:f.triggerField,thisFieldId:a.fields[e],inSection:f.inSection,valKey:f.inSection+""+a.fields[e],thisField:c.fields[a.fields[e]],thisFieldCall:"input"+c.fieldKeys[a.fields[e]]},k=c;"checkbox"==g.thisField.type||"radio"==g.thisField.type||"scale"==g.thisField.type||"star"==g.thisField.type?g.thisFieldCall=g.thisFieldCall+":checked,"+g.thisFieldCall+"[type=hidden]":"select"==g.thisField.type||"time"==g.thisField.type?g.thisFieldCall="select"+
...
"\\$1");b=b.replace(new RegExp(k,"g"),d[g.valKey])}return b}function gb(a){var b=a.charAt(a.length-1);if("+"===b||"-"===b)a=a.substr(0,a.length-1);return a}function A(a){return 3<=a.split("][").length}function ib(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;c[a.valKey]=0;var d=Ga(a);if(!1===d)return c;d.each(function(){var d=Ha(a.thisField,this);if("date"==a.thisField.type){var e=b.date;var h=0;if(d)if("undefined"===typeof jQuery.datepicker){h="-";-1<e.indexOf("/")&&(h="/");
e=e.split(h);d=d.split(h);var g;var k=h=g="";for(var l=0;l<e.length;l++)if("y"==e[l])k=((new Date).getFullYear()+15).toString().substr(2,2),k=d[l]>k?"19"+d[l]:"20"+d[l];else if("yy"==e[l])k=d[l];else if("m"==e[l]||"mm"==e[l])h=d[l],2>h.length&&(h="0"+h);else if("d"==e[l]||"dd"==e[l])g=d[l],2>g.length&&(g="0"+g);h=Date.parse(k+"-"+h+"-"+g)}else h=jQuery.datepicker.parseDate(e,d);e=h;null!==e&&(c[a.valKey]=Math.ceil(e/864E5))}else{e=d;""!==e&&0!==e&&(e=e.trim(),e=parseFloat(e.replace(/,/g,"").match(/-?[\d\.]+$/)));
if("undefined"===typeof e||isNaN(e)||""===e)e=0;c[a.valKey]+=e}});return c}function hb(a,b){if("undefined"!==typeof b[a.valKey]&&""!==b[a.valKey])return b;b[a.valKey]="";var c=Ga(a);if(!1===c)return b;var d=0,f="";c.each(function(){var c=Ha(a.thisField,this);c=c.trim();var h=d,g="";0<h&&("time"==a.thisField.type?1==h?g=":":2==h&&(g=" "):g=", ",h=jQuery(document).triggerHandler("frmCalSeparation",[a.thisField,h]),"undefined"!==typeof h&&(g=h));f=g;""!==c&&(b[a.valKey]+=f+c,d++)});return b}function Ga(a){a=
!1===a.inSection?jQuery(a.thisFieldCall):Ea(a);if(null===a||"undefined"===typeof a||1>a.length)a=!1;return a}function Ea(a){if("undefined"===typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");var c=w(a.triggerField.attr("name"));var d=a.thisFieldCall.replace("[id=","[id^=").replace(/-"]/g,"-"+c.repeatRow+'"]');if(b.length||""!==c.repeatRow){if(c=b.length?b.find(d):jQuery(d),null===c||"undefined"===typeof c||1>c.length)c=null,d.indexOf(":checked")?
1>b.find(d.replace(":checked","")).length&&(c=jQuery(a.thisFieldCall)):c=jQuery(a.thisFieldCall)}else c=jQuery(a.thisFieldCall);return c}function Ha(a,b){var c=!1;if("hidden"==b.type)""!==W(b)&&(c=!0);else if("select"==a.type){var d=b.className;d&&-1<d.indexOf("frm_other_trigger")&&(c=!0)}else("checkbox"==a.type||"radio"==a.type)&&-1<b.id.indexOf("-other_")&&0>b.id.indexOf("-otext")&&(c=!0);c?(c=0,"select"==a.type?"hidden"==b.type?(d=!1,2<b.name.split("[").length&&(d=!0),d||(c=W(b))):c=jQuery(b).closest(".frm_other_container").find(".frm_other_input").val():
"checkbox"!=a.type&&"radio"!=a.type||"hidden"==b.type||(c=W(b))):c="checkbox"!==b.type&&"radio"!==b.type||!b.checked?jQuery(b).val():b.value;"undefined"===typeof c&&(c="");return c}function W(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function jb(a,b){X("pageLoad");var c=jQuery(b).find('input[name="id"]');c.length&&(c=document.getElementById("frm_edit_"+c.val()),null!==c&&-1<c.className.indexOf("frm_cancel_edit")&&Ia(jQuery(c)));G()}function kb(){G()}
function lb(a,b){google.load("visualization","1.0",{packages:[b],callback:function(){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&(d=!0,b.addColumn("number",frm_js.id));for(var f=a.fields.length,e,h=0,g=f;h<g;h++){var k=a.fields[h];e=Ja(k);b.addColumn(e,k.name)}h=!1;a.options.edit_link&&(h=!0,b.addColumn("string",a.options.edit_link));g=!1;a.options.delete_link&&(g=!0,b.addColumn("string",a.options.delete_link));if(null!==a.entries){var l=a.entries.length;
b.addRows(l);for(var m=0,p=0;p<l;p++){k=0;var q=a.entries[p];d&&(b.setCell(m,k,q.id),k++);for(var n=0,r=f;n<r;n++){var t=a.fields[n];e=Ja(t);t=q.metas[t.id];"number"!=e||null!==t&&""!==t?"boolean"==e&&(t=null===t||"false"==t||!1===t?!1:!0):t=0;b.setCell(m,k,t);k++}h&&("undefined"!==typeof q.editLink?b.setCell(m,k,'<a href="'+q.editLink+'">'+a.options.edit_link+"</a>"):b.setCell(m,k,""),k++);g&&("undefined"!==typeof q.deleteLink?b.setCell(m,k,'<a href="'+q.deleteLink+'" class="frm_delete_link" data-frmconfirm="'+
...
typeof __FRMCALC){(a=__FRMCALC.triggers)&&jQuery(a.join()).trigger({type:"change",selfTriggered:!0});a=__FRMCALC.calc;b=[];for(var d in a)1>a[d].fields.length&&(c=document.getElementById("field_"+d),null===c||D(c,a[d].form_id)||P(__FRMCALC,d,b))}Z()}function V(a){if(jQuery().chosen){var b={allow_single_deselect:!0,no_results_text:frm_js.no_results,search_contains:!0};"undefined"!==typeof __frmChosen&&(b="{"+__frmChosen+"}");"undefined"!==typeof a?jQuery("#"+a).find(".frm_chzn").chosen(b):jQuery(".frm_chzn").chosen(b)}}
function tb(){La(this)}function ub(){La(this.previousSibling)}function La(a){var b=a.parentElement;b.className+=" frm-star-hovered";b=b.childNodes;a=parseInt(a.value);for(var c=!1,d=0;d<b.length;d++)"undefined"!==typeof b[d].className&&-1<b[d].className.indexOf("star-rating")?c?b[d].className+=" star-rating-hover":b[d].classList.remove("star-rating-hover","star-rating-on"):c=parseInt(b[d].value)<=a}function vb(){var a=this.previousSibling.parentElement;a.classList.remove("frm-star-hovered");var b=
a.childNodes;a=jQuery(a).find("input:checked").attr("id");for(var c="",d=b.length-1;0<d;d--)"undefined"!==typeof b[d].className&&-1<b[d].className.indexOf("star-rating")&&(b[d].classList.remove("star-rating-hover"),""===c&&"undefined"!==typeof a&&b[d].getAttribute("for")==a&&(c=" star-rating-on"),""!==c&&(b[d].className+=c))}function Ka(){jQuery(document).on("input","input[data-frmrange]",function(){var a=jQuery(this);a.next(".frm_range_value").html(a.val())})}function wb(){var a,b=jQuery(".frm_inline_form .frm_fields_container");
if(b.length)for(a=0;a<b.length;a++){var c=jQuery(b[a]);var d=c.children(".frm_form_field");if(!Ma(d.last())){var f=d;var e=Math.max(2,Math.ceil(12/(f.length+1)));for(d=0;d<f.length;d++)Ma(jQuery(f[d]))||jQuery(f[d]).addClass("frm"+e);c.children(".frm_submit").addClass("frm"+e)}}}function Ma(a){var b;for(b=1;13>b;b++){if(a.hasClass("frm"+b))return!0;if(12===b)return!1}}function X(a){"undefined"!==typeof __frmHideOrShowFields?frmProForm.hideOrShowFields(__frmHideOrShowFields,a):Na()}function Na(){jQuery(".frm_pro_form").fadeIn("slow")}
...
return!1}function eb(a,b){for(var c in a)if(a.hasOwnProperty(c)&&a[c]===b)return c;return null}function Fa(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}var H=!1,Va="",u=0,n={};return{init:function(){jQuery(document).on("frmFormComplete",jb);jQuery(document).on("frmPageChanged",kb);jQuery(document).on("click",".frm_trigger",Oa);var a=jQuery(".frm_blank_field");a.length&&a.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery(document).on("click",".frm_remove_link",Ra);jQuery(document).on("focusin",
"input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString(),{autoclear:!1})});jQuery(document).on("frmFieldChanged",ba);jQuery(document).on("mouseenter click",".frm-star-group input",tb);jQuery(document).on("mouseenter",".frm-star-group .star-rating:not(.star-rating-readonly)",ub);jQuery(document).on("mouseleave",".frm-star-group .star-rating:not(.star-rating-readonly)",vb);jQuery(document).on("click",'.frm-show-form input[type="submit"], .frm-show-form input[name="frm_prev_page"], .frm_page_back, .frm_page_skip, .frm-show-form .frm_save_draft, .frm_prev_page, .frm_button_submit',
Y);jQuery(document).on("change",'.frm_other_container input[type="checkbox"], .frm_other_container input[type="radio"], .frm_other_container select',Ta);jQuery(document).on("click",".frm_remove_form_row",nb);jQuery(document).on("click",".frm_add_form_row",ob);jQuery("a[data-frmtoggle]").click(xb);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",pb);jQuery(".frm_edit_link_container").on("click","a.frm_cancel_edit",qb);jQuery(document).on("click",".frm_ajax_delete",rb);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=
jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");a.hasClass("ui-icon-triangle-1-e")?(a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});wb();X("pageLoad");G()},savingDraft:function(a){var b=!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b},goingToPreviousPage:function(a){var b=
!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+d+'"]');a=a.length?a.val():0;if(!a||c.val()<a)b=!0}return b},hideOrShowFields:function(a,b){if("pageLoad"===b){var c=document.querySelectorAll('[id^="frm_hide_fields_"]');Q(c)}c={repeatingSection:"",repeatRow:""};for(var d=0,f=a.length;d<f;d++)x(a[d],c),d==f-1&&Na()},hidePreviouslyHiddenFields:function(){var a=[];for(var b=document.querySelectorAll('*[id^="frm_hide_fields_"]'),
c=b.length,d,f=0;f<c;f++)d=b[f].id.replace("frm_hide_fields_",""),a=a.concat(z(d));b=0;for(c=a.length;b<c;b++)d=document.getElementById(a[b]),null!==d&&(d.style.display="none")},checkDependentDynamicFields:function(a){for(var b={repeatingSection:"",repeatRow:""},c=0,d=a.length;c<d;c++)x(a[c],b)},checkDependentLookupFields:function(a){for(var b,c={repeatingSection:"",repeatRow:""},d=0,f=a.length;d<f;d++)b=a[d],R(b,c,"value changed")},loadGoogle:function(){if("undefined"!==typeof google&&google&&google.load)for(var a=
__FRMTABLES,b=Object.keys(a),c=0;c<b.length;c++)if("graphs"===b[c])for(var d=a[b[c]],f=0,e=d.length;f<e;f++)mb(d[f]);else for(d=a[b[c]],f=b[c],e=0;e<d.length;e++)lb(d[e],f);else setTimeout(frmFrontForm.loadGoogle,30)},removeUsedTimes:function(a,b){var c=jQuery(a).parents("form:first").find('input[name="id"]');jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_fields_ajax_time_options",time_field:b,date_field:a.id,entry_id:c?c.val():"",date:jQuery(a).val(),nonce:frm_js.nonce},
