        ...
        <div class="frm_repeat_sec">
			...
			<div class="frm_form_field form-field frm6 <?php echo esc_attr( $pos_class ) ?>">
				...
				<div class="frm_opt_container">
					<div class="frm_radio"><input type="radio" /><label><?php _e( 'Option 1', 'formidable-pro' ) ?></label></div>
					<div class="frm_radio"><input type="radio" /><label><?php _e( 'Option 2', 'formidable-pro' ) ?></label></div>
				</div>
			</div>
