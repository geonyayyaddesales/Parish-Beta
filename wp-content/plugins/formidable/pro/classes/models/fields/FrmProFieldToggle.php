...
class FrmProFieldToggle extends FrmFieldType {
	...
	protected function builder_text_field() {
		...
		$args = array( 'html_id' => $this->html_id(), 'field_name' => $this->html_name(), 'is_builder' => true );
	...
	public function front_field_input( $args, $shortcode_atts ) {
		...
		$input .= '<input type="checkbox" name="' . esc_attr( $args['field_name'] ) . '[]" id="' . esc_attr( $args['html_id'] ) . '" value="' . esc_attr( $on_label ) . '" ' . $checked . $input_html . '/>' . "\r\n";
